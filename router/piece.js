  ...
  db.piece
    ...
    .then((pieces) => {
      ...
      if (pieces) {
        ...
        res.json({
          error:
            "you can't delete this pieces it not exist in you list of pieces",
        });
      }
    })
    .catch((err) => {
...
pieces.post("/new", (req, res) => {
  ...
  const marques = { marque: req.body.marque };
  // try to find marque
  db.marque
    .findOne({
            ...
            db.piece
              ...
              .then((pieces) => {
                if (!pieces) {
                  ...
                  res.json({
                    error:
                      "that pieces is allready in your database, if you need you can update",
                  });
                }
              })
              .catch((err) => {
